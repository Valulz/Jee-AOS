...
import fr.despoval.notifei.repository.NotificationRepository;
import fr.despoval.notifei.service.NotificationService;
...
import static fr.despoval.notifei.web.rest.TestUtil.sameInstant;
...
public class NotificationResourceIntTest {
    ...
    public static Notification createEntity(EntityManager em) {
        Notification notification = new Notification()
                .date(DEFAULT_DATE);
        // Add required entity
        UserAE user = UserAEResourceIntTest.createEntity(em);
        em.persist(user);
        em.flush();
        ...
        // Add required entity
        AdverseEffect effect = AdverseEffectResourceIntTest.createEntity(em);
        em.persist(effect);
        em.flush();
        notification.setEffect(effect);
        return notification;
    }
